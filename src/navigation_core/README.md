...
1. Launch the simulation environment from ros2, standing in ros2_harvey root folder:
    ros2 launch ros_gz_sim gz_sim.launch.py gz_args:=simulation/worlds/slu_simulation.sdf
...
3. Spawn robot:
    ros2 launch ros_gz_sim gz_spawn_model.launch.py world:=simulation/worlds/slu_simulation.sdf topic:=robot_description entity_name:=my_vehicle x:=5.0 y:=5.0 z:=0.5